...
var require_encode = __commonJS({
  "node_modules/base64-stream/lib/encode.js"(exports2, module2) {
    var { Transform } = require("stream");
    module2.exports = class Base64Encode extends Transform {
      /**
...
var require_decode = __commonJS({
  "node_modules/base64-stream/lib/decode.js"(exports2, module2) {
    var { Transform } = require("stream");
    module2.exports = class Base64Decode extends Transform {
      /**
...
var require_base64_stream = __commonJS({
  "node_modules/base64-stream/index.js"(exports2, module2) {
    var Base64Encode = require_encode();
...
async function runModuleScript(_context, module2, input) {
  ...
  const result = await (0, import_node_fetch.default)(api, {
    method: "POST",
    headers: {
  ...
  extract.on("entry", (header, stream, next) => {
    ...
    const base64Stream = new import_base64_stream.default.Base64Encode();
